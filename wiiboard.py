...
import time
import pygame
from unityListener import unityListen
...
class BoardEvent:
	def __init__(self, topLeft,topRight,bottomLeft,bottomRight, buttonPressed, buttonReleased, timeVar):
...
class Wiiboard:
	...
	def createBoardEvent(self, bytes, timeVar):
		...
		boardEvent = BoardEvent(topLeft,topRight,bottomLeft,bottomRight,buttonPressed,buttonReleased,timeVar)
		return boardEvent
